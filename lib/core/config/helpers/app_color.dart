...
class AppColor {
  static Color appThemeColor = const Color.fromRGBO(29, 29, 29, 1);
  static Color blue224 = const Color.fromRGBO(43, 169, 224, 1);
  ...
  static Color white205 = const Color.fromRGBO(255, 241, 205, 1);
  static Color brown23 = const Color.fromRGBO(23, 23, 23, 0.4);
  static Color black = const Color.fromRGBO(0, 0, 0, 1);
  static Color black74 = const Color.fromRGBO(74, 74, 74, 1);
  static Color black29 = const Color.fromRGBO(29, 29, 29, 1);
  ...
  static Color green63 = const Color.fromRGBO(139, 200, 63, 1);
  static Color brown36 = const Color.fromRGBO(130, 92, 36, 1);
  static Color brown2 = const Color.fromRGBO(253, 86, 2, 1);
