...
import 'package:music_app_student/core/presentation/pages/my_guitar/controller/my_guitar_classes_detail_controller.dart';
...
class MyGuitarClassesDetailPage extends StatelessWidget {
  ...
  final controller = Get.put(MyGuitarClassesDetailController());

  @override
  Widget build(BuildContext context) {
    return GetBuilder<MyGuitarClassesDetailController>(builder: (context) {
      return Scaffold(
        appBar: CustomAppBar(
          onBackPressed: () {
