...
import 'package:music_app_student/core/presentation/pages/edit_profile/controller/edit_profilee_controller.dart';
import 'package:sizer/sizer.dart';
import 'package:velocity_x/velocity_x.dart';

class EditProfileePage extends StatelessWidget {
  EditProfileePage({super.key});
  final controller = Get.put(EditProfileeController());
  @override
    ...
    return Stack(
      children: [
        SizedBox(
          ...
          child: Stack(
            children: [
              Image.asset("assets/images/unsplash_profile_1.png"),
              Container(
