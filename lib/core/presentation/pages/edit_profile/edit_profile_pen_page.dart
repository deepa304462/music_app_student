...
import 'package:music_app_student/core/presentation/pages/edit_profile/controller/edit_profile_pen_controller.dart';
import 'package:sizer/sizer.dart';
import 'package:velocity_x/velocity_x.dart';

class EditProfilePenPage extends StatelessWidget {
  EditProfilePenPage({super.key});
  final controller = Get.put(EditProfilePenController());
  @override
    ...
    return Stack(
      children: [
        SizedBox(
          ...
          child: Stack(
            children: [
              Image.asset("assets/images/unsplash_profile.png"),
              Container(
