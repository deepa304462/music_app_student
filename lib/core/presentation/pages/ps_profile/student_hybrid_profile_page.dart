...
import 'controller/student_hybrid_profile_controller.dart';

class StudentHybridProfilePage extends StatelessWidget {
  StudentHybridProfilePage({super.key});
  final controller = Get.put(StudentHybridProfileController());
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      body: SingleChildScrollView(
        child: Stack(
          children: [
            Image.asset("assets/images/hybrid_bg.png"),
            Container(
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          Expanded(
                            child: _medalsCard(
                              image: SvgPicture.asset("assets/svg/gold.svg"),
                          ...
                          Expanded(
                            child: _medalsCard(
                              image: SvgPicture.asset("assets/svg/silver.svg"),
                              title: "Silver",
                              subTitle: "18",
                          ...
                          Expanded(
                            child: _medalsCard(
                              image: SvgPicture.asset("assets/svg/Bronze.svg"),
                              title: "Bronze",
                              subTitle: "18",
          ...
          Container(
            ...
            decoration: const BoxDecoration(
              image: DecorationImage(
                fit: BoxFit.fill,
                image: AssetImage("assets/images/hybrid_bg.png"),
              ),
            ),
          ),
          Padding(
                    ...
                    children: List.generate(
                      ...
                      (index) => Container(
                        ...
                        child: Row(
                          children: [
                            SvgPicture.asset(
                              "${controller.badgesList[index]['image']}",
                              height: 40,
                              width: 40,
                            ),
                            2.w.widthBox,
                            Column(
                              ...
                              children: [
                                Text(
                                  "${controller.badgesList[index]['name']}",
                                  style: TextStyle(
