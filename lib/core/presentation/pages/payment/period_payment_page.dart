...
import 'controller/period_payment_controller.dart';

class PeriodPaymentPage extends StatelessWidget {
  PeriodPaymentPage({super.key});
  final controller = Get.put(PeriodPaymentController());
  @override
  Widget build(BuildContext context) {
    return GetBuilder<PeriodPaymentController>(builder: (context) {
      return Scaffold(
        appBar: _appBar(),
              ...
              Row(
                ...
                children: [
                  ...
                  Text(
                    ...
                    style: TextStyle(
                      fontFamily: AppTextStyle.textStyleNunitoSans,
                      fontSize: 12,
